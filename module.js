...
exports.ExampleConfigCtrl = void 0;

var ExampleConfigCtrl = /*#__PURE__*/function () {
  ExampleConfigCtrl.$inject = ["$scope", "$injector"];

  /** @ngInject */
  function ExampleConfigCtrl($scope, $injector) {
    _classCallCheck(this, ExampleConfigCtrl);
  ...
  _createClass(ExampleConfigCtrl, [{
    key: "postUpdate",
...
exports.ExampleConfigCtrl = ExampleConfigCtrl;
...
exports.ConfigCtrl = void 0; // Angular pages

var config_1 = __webpack_require__(/*! ./legacy/config */ "./legacy/config.ts");

Object.defineProperty(exports, "ConfigCtrl", {
  enumerable: true,
  get: function get() {
    return config_1.ExampleConfigCtrl;
  }
});
